def runAction(self, event):
	...
	query = "UPDATE indendinfo SET PR_Title = ?, Part_No = ?, Part_Description = ?, QYT = ?, Expense_Booking = ?, Section = ?, Category = ?, Category_ID = ? WHERE ID = ?"
	args = [PR_Title, Part_No, Part_Description, QYT, Expense_Booking, Section, Category, ID, Category_ID]
